...
export class ScriptSynthEngine {
  ...
  constructor(sampleRate: number, numChannels: number) {
    ...
    this._instruments['fm_sample'] = new ScriptSynthFmInstrument(
      new FmAlgorithmNode('sine', false, 1, [{ time: 0, value: 1 }, { time: 1, value: 0 }], [{ time: 1, value: 0 }],  [
        new FmAlgorithmNode('sine', false, 3, [{time: 0, value: 0.27}, {time: 2, value: 0.22}], [], [
          new FmAlgorithmNode('sine', false, 7, [{time: 0, value: 0.5 }, {time: 0.030, value: 0.23}], [], [
            new FmAlgorithmNode('sine', false, 16, [{time: 0, value: 0.37 }, {time: 0.05, value: 0.20}], [], [])
          ])
        ])
      ])
    );
